...
<div class="content-card">
    ...
    <div class="card-body">
        ...
        <div style="display:flex;gap:8px;margin-top:16px;flex-wrap:wrap">
            ...
            <form method="post" action="{{ route('physician.appointments.reject', $appointment) }}" style="display:flex;gap:8px;align-items:center">@csrf<input name="reason" class="form-control" placeholder="Rejection reason" required style="max-width:200px"><button class="btn btn-danger btn-sm">Reject</button></form>
            @endif
