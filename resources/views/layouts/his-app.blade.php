...
<head>
    ...
    <title>@yield('title', 'WPU Health Services') — WPU Health Services</title>
...
<div class="main-content">
    ...
    <div class="container">
        ...
        <div class="header">
            <div class="breadcrumbs"><a href="{{ $breadcrumbHomeUrl ?? url('/') }}">{{ $breadcrumbHomeLabel ?? 'Home' }}</a> <span>/</span> <span>@yield('title')</span></div>
